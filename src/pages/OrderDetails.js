...
const OrderDetails = () => {
  ...
  useEffect(() => {
    // Assuming you have a way to fetch selectedItem based on order data or another source
    // Replace this with your actual logic to fetch selectedItem
    // For demonstration purposes, initializing with default values
    setSelectedItem({ name: "Pizza Category", price: 100 });
  }, [order]);
  ...
  const handleSaveOrder = async () => {
    try {
      ...
      setEditMode(false);
      navigate("/Home"); // Navigate to the Thank You page
    } catch (error) {
  ...
  if (!order || !selectedItem) return <div>Loading...</div>;
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  value={selectedItem.name || ""} // Display selected menu item
                  onChange={handleInputChange}
                  disabled={!editMode}
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <input
                  type="text"
                  name="price"
                  value={selectedItem.price || ""} // Display selected menu item price
                  onChange={handleInputChange}
                  disabled={!editMode}
                />
              </td>
